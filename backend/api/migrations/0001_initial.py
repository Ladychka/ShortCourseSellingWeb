# Generated by Django 4.2 on 2025-08-31 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, null=True, upload_to='course-image')),
                ('title', models.CharField(max_length=200)),
                ('description', models.TextField(blank=True, null=True)),
                ('price', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True)),
                ('language', models.CharField(default='English', max_length=50)),
                ('level', models.CharField(default='Beginner', max_length=50)),
                ('platform_status', models.CharField(default='active', max_length=50)),
                ('teacher_status', models.CharField(default='available', max_length=50)),
        ...
        migrations.AddField(
            model_name='cartorderitem',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orderitem', to='api.course'),
        ),
        migrations.AddField(
            model_name='cartorderitem',
            name='order',
