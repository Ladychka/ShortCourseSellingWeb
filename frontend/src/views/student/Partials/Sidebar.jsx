                    ...
                    <div className="navbar-nav flex-column">
                        <ul className="list-unstyled ms-n2 mb-4">
                            <li className="nav-item">
                                <Link className="nav-link" to={`/student/dashboard/`}> <i className='bi bi-grid-fill me-2'></i> Dashboard</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`/student/courses/`}> <i className='fas fa-shopping-cart me-2'></i>My Courses</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`/student/wishlist/`}> <i className='fas fa-heart me-2'></i>Wishlist</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`/student/question-answer/`}> <i className='fas fa-envelope me-2'></i>Q/A</Link>
                            </li>
                        </ul>
                        ...
                        <ul className="list-unstyled ms-n2 mb-0">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" to={`/logout/`}> <i className='fas fa-sign-out-alt'></i> Sign Out</Link>
                            </li>
                        </ul>
                    </div>
                </div>
